...
class A {
    ...
    startEmbeddedContent(e) {
        e && !this.Reveal.isSpeakerNotes() && (a(e, 'img[src$=".gif"]').forEach((e => {
            ...
            if ("boolean" != typeof t && (t = e.hasAttribute("data-autoplay") || !!l(e, ".slide-background")), t && "function" == typeof e.play)
...
class k {
    ...
    sync(e) {
        ...
        if (s) {
            const t = E(s);
            t && 0 !== t.a && ("string" == typeof(o = s) && (o = E(o)), (o ? (299 * o.r + 587 * o.g + 114 * o.b) / 1e3 : null) < 128 ? e.classList.add("has-dark-background") : e.classList.add("has-light-background"))
        }
        var o
    }
    update(e = !1) {
...
class x {
    ...
    run(e, t) {
        ...
        if (e.hasAttribute("data-auto-animate") && t.hasAttribute("data-auto-animate") && e.getAttribute("data-auto-animate-id") === t.getAttribute("data-auto-animate-id") && !(a > n ? t : e).hasAttribute("data-auto-animate-restart")) {
            ...
            let s = this.getAutoAnimatableElements(e, t).map((e => this.autoAnimateElements(e.from, e.to, e.options || {}, i, L++)));
            if ("false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
                ...
                this.getUnmatchedAutoAnimateElements(t).forEach((e => {
                    let t = this.getAutoAnimateOptions(e, i),
                        a = "unmatched";
                    t.duration === i.duration && t.delay === i.delay || (a = "unmatched-" + L++, s.push(`[data-auto-animate="running"] [data-auto-animate-target="${a}"] { transition: opacity ${t.duration}s ease ${t.delay}s; }`)), e.dataset.autoAnimateTarget = a
...
class q {
    ...
    onTouchMove(e) {
        if (this.isSwipePrevented(e.target)) return !0;
        let t = this.Reveal.getConfig();
        if (this.touchCaptured) f && e.preventDefault();
        else {
            this.Reveal.onUserInput(e);
...
function V(t, r) {
    ...
    function ve() {
        R = !0, pe(), me(), Re(), we(), et(), Ae(), ae.readURL(), G.update(!0), setTimeout((() => {
        ...
        }), 1), le.isPrintingPDF() && (Ee(), "complete" === document.readyState ? le.setupPDF() : window.addEventListener("load", (() => {
            le.setupPDF()
        })))
    }
    ...
    function Re() {
        w.postMessage && window.addEventListener("message", (t => {
            let i = t.data;
            if ("string" == typeof i && "{" === i.charAt(0) && "}" === i.charAt(i.length - 1) && (i = JSON.parse(i), i.method && "function" == typeof c[i.method]))
                if (!1 === e.test(i.method)) {
    ...
    function _e(e) {
        "boolean" == typeof e ? e ? St() : At() : _ ? St() : At()
    }
    ...
    function Ze() {
        Ee(), Se(), He(), j = w.autoSlide, wt(), G.create(), ae.writeURL(), ee.sortAll(), ne.update(), se.update(), at(), he.update(), he.updateVisibility(), G.update(!0), Q.update(), J.formatEmbeddedContent(), !1 === w.autoPlayMedia ? J.stopEmbeddedContent(f, {
            unloadIframes: !1
    ...
    function Et() {
        E.hasNavigatedHorizontally = !0, w.rtl ? (te.isActive() || !1 === ee.next()) && nt().left && Qe(g + 1, "grid" === w.navigationMode ? v : void 0) : (te.isActive() || !1 === ee.prev()) && nt().left && Qe(g - 1, "grid" === w.navigationMode ? v : void 0)
    }

    function kt() {
        E.hasNavigatedHorizontally = !0, w.rtl ? (te.isActive() || !1 === ee.prev()) && nt().right && Qe(g - 1, "grid" === w.navigationMode ? v : void 0) : (te.isActive() || !1 === ee.next()) && nt().right && Qe(g + 1, "grid" === w.navigationMode ? v : void 0)
    }
    ...
    function xt() {
        E.hasNavigatedVertically = !0, (te.isActive() || !1 === ee.next()) && nt().down && Qe(g, v + 1)
    }
    ...
    function Pt() {
        if (E.hasNavigatedHorizontally = !0, E.hasNavigatedVertically = !0, !1 === ee.next()) {
            let e = nt();
            e.down && e.right && w.loop && We() && (e.down = !1), e.down ? xt() : w.rtl ? Et() : kt()
        }
    }

    function Nt(e) {
        w.autoSlideStoppable && At()
    }
    ...
    const Ht = {
        ...
        hasNavigatedHorizontally: () => E.hasNavigatedHorizontally,
        hasNavigatedVertically: () => E.hasNavigatedVertically,
